    ...
    class ChatCompletions:
        def create(self, model, messages, max_tokens=3000, temperature=0.8):
            class MockResponse:
                ...
                def __init__(self):
                    self.message = MockArk.ChatCompletions.MockResponse.Choices.Message()
                
            class MockChoices:
                def __init__(self):
                    self.choices = [MockArk.ChatCompletions.MockResponse.Choices()]
                
            return MockArk.ChatCompletions.MockResponse()
...
class AIClient:
    def __init__(self, api_key=None, model_name='doubao-seed-1-6-250615'):
        """初始化AI客户端"""
        # 从环境变量获取API密钥，避免硬编码
